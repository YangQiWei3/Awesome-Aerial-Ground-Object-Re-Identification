...
> Counts are computed from the paper tables in this README.
...
> Tip: You can enrich this table with **#IDs / #images / #cameras/views**, train/test split protocols, and evaluation metrics (mAP, Rank-1, etc.).
...
We thank the AG-ReID community for open-sourcing papers, code, datasets, and benchmarks that accelerate research progress.

## 📧 Contact

Questions, suggestions, and collaborations are welcome:

- **Email**: [yangqiwei62xg@gmail.com](mailto:yangqiwei62xg@gmail.com)
- **GitHub**: [YangQiWei3](https://github.com/YangQiWei3)
